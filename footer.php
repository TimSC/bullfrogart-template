...
<div class="sociallinkinfooter" style="font-size:50%;">Copyright &copy; Emma Bentley, 2011-2017. All rights reserved.<a href="<?php echo get_site_url();?>?p=<?php echo $legal_id;?>">Legal notices</a>.</div>
</div>
</div>
